...
parser.add_argument('--outf', default='3_tuple', help='folder to output images and model checkpoints')
...
#导入训练数据集
train_set = TrainDatasetFromFolder('E:/AEGAN-master/patch_data_96/train', crop_size=CROP_SIZE, blocksize=BLOCK_SIZE)
...
#512*512
data_dir_64 = 'E:/CSNET_con/celeba_64/celeba-64'          # this path depends on your computer
