...
from aegan_model import _netG1, _netD1,_netG1_64,_netD1_64, _netD2,reshape,recover, AEGAN_ResnetGenerator, AEGAN_ResnetDecoder, \
    NLayerDiscriminator
...
parser.add_argument('--sub_dir2', default='imgStep2&3_2_nor_lr_0.00001_128', help='the sub directory 2 of saving images')
parser.add_argument('--sub_dir3', default='imgStep2&3_3_nor_lr_0.0001_128', help='the sub directory 3 of saving images')
...
#存储gan模型
pickle_save_path = os.path.join(opt.outf, 'GAN_32_nor_auto refine_STEP2&3_128_3tuple_lr_0.00001' + '_subrate_' + str(opt.sub_rate) + '_blocksize_' + str(BLOCK_SIZE))
if not os.path.exists(pickle_save_path):
    os.makedirs(pickle_save_path)

#存储refine模型
refine_save_path = os.path.join(opt.outf, 'Refine_nor_auto refine_STEP2&3_128_3tuple_0.0001' + '_subrate_' + str(opt.sub_rate) + '_blocksize_' + str(BLOCK_SIZE))
...
#print(netG1)
netD1 = _netD1(ndf)
netD1.load_state_dict(torch.load('./img_128_3_tuple_csnet_subrate_0.0625+gan_con_32/GAN_32_nor_STEP2_128_3tuple_subrate_0.0625_blocksize_32/netD1_epoch_101_1.696467.pth'))
...
# setup optimizer
optimizerD1 = optim.Adam(netD1.parameters(), lr=opt.lr*0.1, betas=(opt.beta1, 0.999))
optimizerG1 = optim.Adam(netG1.parameters(), lr=opt.lr*0.1, betas=(opt.beta1, 0.999))
    ...
    for epoch in range(opt.niter_stage2):
        for i, data in enumerate(dataloader, 0):
            ...
            if i % 100 == 0:
                ...
                fake = netG2(RECOVER(netG1(noise)))
