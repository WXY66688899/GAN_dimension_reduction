...
from torchvision.transforms import Compose, RandomResizedCrop, RandomHorizontalFlip, RandomVerticalFlip, \
    RandomRotation, RandomCrop, ToTensor, ToPILImage, CenterCrop, Resize, Grayscale,Normalize
...
def psnr(img1, img2):
    ...
    if mse < 1.0e-10:
        return 100
    PIXEL_MAX = 1.0
    return 10 * math.log10(PIXEL_MAX/mse.item())#20 * math.log10(PIXEL_MAX/math.sqrt(mse))
...
class TrainDatasetFromFolder(Dataset):
    ...
    def __getitem__(self, index):
        try:
            ...
            hr_image= Normalize(0.5, 0.5, 0.5)(hr_image)
