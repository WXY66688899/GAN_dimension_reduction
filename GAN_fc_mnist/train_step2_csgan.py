...
net.load_state_dict(torch.load('./CSNET_lite_3_MNISTdgist_subrate_0.25/net_epoch_50_0.009493.pth'))
...
if __name__=="__main__":
    ...
    for epoch in range(1, n_epoch + 1):
        ...
        img_dir = './img_mnist_CSGAN_0.25_Z_30'
        ...
        # for saving model
        save_dir = './CSGAN_FC_mnist_28_SUBRATE_0.25' + '_zdim_' + str(z_dim)
