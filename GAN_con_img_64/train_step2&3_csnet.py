...
parser.add_argument('--outf', default='img_64_3_tuple_csnet_lite_subrate_0.25+gan_con_auto_refine', help='folder to output images and model checkpoints')
...
parser.add_argument('--sub_dir2', default='imgStep2&3_2_nor_64', help='the sub directory 2 of saving images')
parser.add_argument('--sub_dir3', default='imgStep2&3_3_nor_64', help='the sub directory 3 of saving images')
...
#存储gan模型
pickle_save_path = 'GAN_nor_auto refine_STEP2&3_64_3tuple' + '_subrate_' + str(opt.sub_rate) + '_blocksize_' + str(BLOCK_SIZE)
if not os.path.exists(pickle_save_path):
    os.makedirs(pickle_save_path)

#存储refine模型
refine_save_path = 'Refine_nor_auto refine_STEP2&3_64_3tuple' + '_subrate_' + str(opt.sub_rate) + '_blocksize_' + str(BLOCK_SIZE)
